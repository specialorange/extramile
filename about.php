  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <h1 class="page-header">About <small>our story</small></h1>
          <ol class="breadcrumb">
      ...
      <div class="row">
        ...
        <div class="col-md-6">
          ...
          <p>Extra Mile Vending opened its doors in January of 2004 with 10 soda machines.  Through our customer referrals we have grown to over 800 machines including soda, snack, arcades, bar games, bulk vending machines and more.  We set up & service machines within a 50 mile radius of Charlotte and have 3 locations in Charlotte, Concord and Statesville to best serve our customers.  Look for upcoming news on our 4th and newest location opening soon in Shelby which will serve as our arcade game headquarters and also the home for 2 new vending routes.</p>

          <p>In 2010, we opened a new used equipment division to provide top quality refurbished and affordable equipment to smaller vendors and independent business owners wishing to own and operate their own vending equipment.  See our used equipment page for our current inventory.</p>
        </div>
      ...
      <div class="row">
        ...
        <div class="col-sm-4">
          <img class="img-responsive" src="http://placehold.it/750x450">
            <h3>Jeff Dahlgard <small>President</small></h3>
...
<!--
 ...
 -->
        ...
        <div class="col-sm-4">
          <img class="img-responsive" src="http://placehold.it/750x450">
            <h3>Daniel Smith <small>Warehouse Manger</small></h3>
...
<!--
 ...
 -->
        ...
        <div class="col-sm-4">
          <img class="img-responsive" src="http://placehold.it/750x450">
            <h3>Josh Nanney <small>South Charlotte Sales Manger</small></h3>
...
<!--
 ...
 -->
        ...
        <div class="col-sm-4">
        	<img class="img-responsive" src="http://placehold.it/750x450">
            <h3>Melissa Outz <small>Invoices/Accounting</small></h3>
            <h4><small>&nbsp</small></h4>
